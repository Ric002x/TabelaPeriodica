...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        activity1 = {
            ...
            'description': "Esta atividade aborda o ciclo da água, " +
            "destacando os processos de evaporação, condensação e " +
            "precipitação. Os alunos aprenderão como a água se move " +
            "através da atmosfera, solo e corpos d'água, e sua importância " +
            "para o equilíbrio ecológico. A atividade também foca na " +
            "relação entre o ciclo da água e as mudanças climáticas, " +
            "com ênfase na importância da preservação dos recursos hídricos.",
        ...
        activity4 = {
            ...
            'description': "Esta atividade oferece uma introdução ao Teorema " +  # noqa
